            ...
            >
              ...
              <div className="space-y-2 text-center sm:text-left">
                <div className="space-y-0.5">
                  <p className="text-xl font-semibold text-gray-800">{report.name || report.reportType}</p>
                  <p className="font-medium text-gray-500">{report.contact || "N/A"}</p>
                </div>
                ...
                <div className="text-sm font-medium text-gray-600">
                  ...
                  <span className="text-blue-500">
                    {report.type === "incident" ? "Incident" : "Emergency"}
                  </span>
                </div>
                <div className="text-sm font-medium text-gray-600">
